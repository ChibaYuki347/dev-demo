...
> 🇯🇵 Japanese version: [`docs/ja/04-ai-context.md`](../ja/04-ai-context.md)
...
`CLAUDE.md` and `GEMINI.md` work the same way for those specific tools — we keep things to `AGENTS.md` here for brevity.
